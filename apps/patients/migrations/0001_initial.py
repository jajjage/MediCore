    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nin_encrypted', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'patients',
                'indexes': [models.Index(fields=['email'], name='patients_email_bf0efb_idx'), models.Index(fields=['last_name', 'first_name'], name='patients_last_na_ce6411_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='demographics', to='patients.patient')),
            ],
            options={
                'db_table': 'patient_demographics',
                'permissions': [('view_patient', 'Can view patient'), ('view_patient_demographics', 'Can view patient demographics')],
            },
        ),
        migrations.CreateModel(
            name='PatientAddress',
            ...
            options={
                ...
                'permissions': [('view_patient', 'Can view patient'), ('view_patient_address', 'Can view patient address')],
