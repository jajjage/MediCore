...
def convert_queryset_to_role_permissions(permissions_queryset) -> Dict[str, Dict[str, List[str]]]:
    """
    ...
    for model in permissions_dict:
        permissions_dict[model] = sorted(list(set(permissions_dict[model])))
